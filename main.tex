...
%%% TODO >>> Wszystkie artykuły cytujemy przez \cite
...
%%% TODO >>> Poprawić interpretację SHAP jako rodzielającą różnicę pomiędzy wartość predykcji - średnia wartość w populacji.
...
\begin{landscape}
{\footnotesize
\section{Ważne tabele.}\label{sec:zalacznik}

\begin{longtable}{lll}
\caption{Zmienne ze zbioru CDC użyte w dalszej części pracy. \textit{Źródło:} opracowanie własne.}\label{table:zmienneCDC}\\
\hline
